...
def init_t_network(debug=False):
  ...
  state = restore_checkpoint(model_cls, state, "/kmh-nfs-ssd-eu-mount/logs/sqa/sqa_Flow_matching/20241214_222845_zlf55q_kmh-tpuvm-v3-32-preemptible-1__b_lr_ep_eval/checkpoint_19400", {}) # change the path to the checkpoint path here !!!!!!!!!
